...
static const _NormalizedImageCrop_Event_type_support_symbol_names_t _NormalizedImageCrop_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, depthai_ros_msgs, srv, NormalizedImageCrop_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, depthai_ros_msgs, srv, NormalizedImageCrop_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, depthai_ros_msgs, srv, NormalizedImageCrop_Event)() {
  return &::depthai_ros_msgs::srv::rosidl_typesupport_c::NormalizedImageCrop_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t NormalizedImageCrop_service_type_support_handle = {
  ...
  &NormalizedImageCrop_Request_message_type_support_handle,
  &NormalizedImageCrop_Response_message_type_support_handle,
  &NormalizedImageCrop_Event_message_type_support_handle,
